      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
             ...
             {/* 
                The 'Upgrade to Admin' button is commented out because admin status is now 
                determined by the email in the Firestore security rules, making this button obsolete.
